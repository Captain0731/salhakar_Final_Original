            ...
            <div className="mb-3 sm:mb-4 md:mb-6">
              ...
              <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row gap-2 sm:gap-3">
                <motion.button
                  ...
                  className="flex-1 sm:flex-none px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 active:bg-blue-800 transition-all font-medium shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base whitespace-nowrap"
                  style={{ fontFamily: 'Roboto, sans-serif' }}
                >
                  {loading || isSearching ? (
                    <>
